...
<body class="menu-always-on-top">
    ...
    <div class="about-block content content-center" id="about">
        <div class="container">
            <h2><strong><b>LEVEL 2 SELECTED LIST</b></strong></h2>
        </div>
    </div>
    <!-- Team block BEGIN -->
...
<h4><strong>CUT-OFF SCORE FOR PYTHON:</strong> 14/20<br>
	<strong>PYTHON LEVEL 2 EXAM DATE:</strong> 28th February 2018 (12:30 PM)
	<br><strong>PYTHON FINAL EXAM DATE:</strong> <del>06th</del> 08th March 2018 - 1:00 PM 
</h4>
...
<?php
				...
				$query1= "select username, max(grade) as grade from cml1_user u, cml1_quiz_grades g where u.id=g.userid and quiz=3 and username not in ('codemaster', 'admin', 'siva', 'python', 'pavan', 'kiran', 'java', 'guest', 'c_admin', 'admin') and grade > 10.0 group by username order by grade desc";
...
<h4><strong>CUT-OFF SCORE FOR JAVA:</strong> 10/20<br>
<strong>JAVA LEVEL 2 EXAM DATE:</strong> 27th February 2018 (12:30 PM)
	<br><strong>JAVA FINAL EXAM DATE:</strong> <del>03rd</del> 06th March 2018 - 1:00 PM 
				</h4>

<div class="col-md-12">
<?php
				
				$query1= "select username, max(grade) as grade from cml1_user u, cml1_quiz_grades g where u.id=g.userid and quiz=4 and username not in ('codemaster', 'admin', 'siva', 'python', 'pavan', 'kiran', 'java', 'guest', 'c_admin', 'admin') and grade > 10.0 group by username order by grade desc";
		     	$result1 = mysqli_query($conn2, $query1);
...
?>
            ...
            <h4><strong>CUT-OFF SCORE FOR C:</strong> 16/20 (for CSE/IT/ECE) 13/20 (for MECH/CIVIL/EEE)<br>
			<strong>C LEVEL 2 EXAM DATE:</strong> 01st March 2018 (for 2/4, 3/4, & 4/4), 05th March 2018 (for 1/4) - 12:30PM
				<br><strong>C FINAL EXAM DATE:</strong> <del>07th</del> 12th March 2018 - 1:00 PM 
			</h4>
            <div class="col-md-12">
<?php
				
				
				$query1= "select username, max(grade) as grade from cml1_user u, cml1_quiz_grades g where u.id=g.userid and quiz=2 and username not in ('codemaster', 'admin', 'siva', 'python', 'pavan', 'kiran', 'java', 'guest', 'c_admin', 'admin') and grade > 10.0 group by username order by grade desc";
		     	$result1 = mysqli_query($conn2, $query1);
