...
{
    if ($rank == 1) {
        $prize = "<span style='color:green;'>Python Final Winner - TITAN Watch</span>";
        return $prize;
    } elseif ($rank == 2) {
        $prize = "<span style='color:green;'>Python Final Winner - TITAN Watch</span>";
        return $prize;
    } elseif ($rank == 3) {
        $prize = "<span style='color:blue;'>C Final Winner - APPLE iPhone SE</span>";
        return $prize;
    } elseif ($rank == 4) {
        $prize = "<span style='color:green;'>JAVA Final Winner - FOSSIL Watch</span>";
        return $prize;
    } elseif ($rank == 5) {
        $prize = "<span style='color:green;'>Women Coder of SRKREC - TITAN Watch</span>";
        return $prize;
    } elseif ($rank == 6) {
