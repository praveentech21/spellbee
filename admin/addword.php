...
if(isset($_POST['addnewword'])){
  ...
  // Handle the rest of the form data and database insertion here
  ...
  // Perform database insertion using the form data and the uploaded file path
  // You can add your database insertion code here
  
  // After successful database insertion, you can redirect or display a success message
}
          ...
          <div class="card-body">
            <form method="post" action="#" onsubmit="return validateForm();">
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <div class="input-group input-group-merge">
                    <input type="qid" name="qid" id="qid" autocomplete="off" class="form-control" placeholder="Question Id" required />
                  </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" id="option1" autocomplete="off" name="option1" class="form-control phone-mask" placeholder="Options for this words" />
                </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" id="option2" autocomplete="off" name="option2" class="form-control phone-mask" placeholder="Options for this words" />
                </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" id="option3" autocomplete="off" name="option3" class="form-control phone-mask" placeholder="Options for this words" />
                </div>
