				...
				<div class="accordion accordion-secondary" id="accordion2Primary">
								<div class="card card-default">
									...
									<div id="collapse2PrimaryOne" class="collapse hide">
										...
										<p>
	  		  <div id='claim_err' style='text-align:center;font-size:14px;'>Click on the buttons to claim your prize</div>			  <div style='text-align:center;' id='claims'>
              <?php
...
<div>
					  ...
					  <h4 align='center' style='color:#000000;'>FEEDBACK / SUGGESTIONS</h4>
					  
											<div class="input-group mb-3" style='padding-top:10px;'>
														<input type="text" id='msg1' class="form-control" placeholder='Write Feedback / Suggestions Here!' data-plugin-maxlength maxlength="1000" REQUIRED>
