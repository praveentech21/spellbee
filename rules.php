...
<body class="menu-always-on-top">
    ...
    <div class="about-block content content-center" id="about">
        <div class="container">
            ...
            <br><br><br><br>
            Disclaimer: The decisions & rules above are bound to change on the discretion of the organisers. The prizes and gifts mentioned are subject to change and may not be the exact products/items as displayed on the webste.
            <br><br><br><br>
            <br><br><br><br>
